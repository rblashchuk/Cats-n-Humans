...
public class ATMAddFundsTransaction implements Transaction {
    private String id;
    private Account account;
    private double funds;
    private boolean cancelled;
    private TransactionType type;
    public ATMAddFundsTransaction(Account account, double funds) {
        this.id = UUID.randomUUID().toString();
        this.account = account;
        this.funds = funds;
        this.cancelled = false;
        this.type = TransactionType.ATMAddFundsType;
    }
